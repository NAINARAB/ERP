import numberToWords from "../../components/numberToString";
    ...
    return (
        <>
                ...
                <table className="table mb-0">
                    <tbody>
                        <tr>
                            ...
                            <td style={{ verticalAlign: 'middle' }}>
                                <p className="fa-13 mb-0">GSTIN {companyInfo?.Company_GSTIN}</p>
                                <p className="fa-13 mb-0">PHONE {companyInfo?.Company_Mobile}</p>
                                <p className="fa-13 mb-0">FSSAI {companyInfo?.fssai_no}</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div className="row ">
                ...
                <div className="col-2 d-md-flex justify-content-center">
                    <img src={companyDetails[companyInfo?.Company_Id]?.logo} className="invoiceLogo" alt="company_logo" />
                </div>

                <div className="col-10 col-md-7 p-2 d-flex flex-column justify-content-center">
                    <p className="mb-0 ">{companyInfo?.Company_Name}</p>
                    <p className="mb-0 text-muted">{companyInfo?.Company_address_1}</p>
                    <p className="mb-0 text-muted fa-14">{companyInfo?.Company_address_2}</p>
                    {companyInfo?.Company_address_3 && <p className="mb-0 text-muted fa-14">{companyInfo?.Company_address_3}</p>}
                ...
                <div className="col-12 col-md-3 p-2 d-flex flex-column justify-content-center">
                    <p className="mb-0 fa-13 d-flex">
                        <span className="flex-grow-1 text-muted">GSTIN </span>
                        <span > {companyInfo?.Company_GSTIN}</span>
                    </p>
                    <p className="mb-0 fa-13 d-flex">
                        <span className="flex-grow-1 text-muted">PHONE</span>
                        <span>{companyInfo?.Company_Mobile}</span>
                    </p>
                    <p className="mb-0 fa-13 d-flex">
                        <span className="flex-grow-1 text-muted">FSSAI</span>
                        <span>{companyInfo?.fssai_no}</span>
                    </p>
                </div>
